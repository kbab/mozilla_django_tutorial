...
class LoanedBookInstanceByUserListViewTest(TestCase):
    def setUp(self):
        # Create two users
        test_user1 = User.objects.create_user(username='testuser1', password='oluwaseun01')
        test_user2 = User.objects.create_user(username='testuser2', password='oluwaseun02')
    ...
    def test_logged_in_users_correct_template(self):
        login = self.client.login(username='testuser1', password='oluwaseun01')
        response = self.client.get(reverse('my-borrowed'))
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        # Check our user is logged in
        self.assertEqual(str(response.context['user']), 'testuser1')
        # Chect that we got a response "success"
        self.assertEqual(response.status_code, 200)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        login = self.client.login(username='testuser2', password='oluwaseun02')
        response = self.client.get(reverse('renew-book-librarian', 
    ...
    def test_uses_correct_template(self):
        ...
        # Check we used correct template
        self.assertTemplateUsed(response, 'catalog/book_renewal_librarian.html')
